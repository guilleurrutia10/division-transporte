...
class Ui_WidgetMostrarTiposDeReparaciones(object):
    def setupUi(self, WidgetMostrarTiposDeReparaciones):
        ...
        self.groupBox_4.setMaximumSize(QtCore.QSize(300, 45))
        ...
        self.label.setText(QtGui.QApplication.translate("WidgetMostrarTiposDeReparaciones", "Nombre Tipo de Reparación", None, QtGui.QApplication.UnicodeUTF8))
