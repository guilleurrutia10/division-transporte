...
"Repuesto", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.buttonBox = QtGui.QDialogButtonBox(DialogCrearReparacion)
        ...
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8("accepted()")), DialogCrearReparacion.accept)
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8("rejected()")), DialogCrearReparacion.reject)
