...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.groupBox.setTitle(QtGui.QApplication.translate("Dialog", "Buscar por Nº Documento", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.groupBox_2.setTitle(QtGui.QApplication.translate("Dialog", "Buscar por Nombre", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.pushButton_Cambiar.setGeometry(QtCore.QRect(270, 10, 75, 23))
        self.pushButton_Cambiar.setText(QtGui.QApplication.translate("Dialog", "Cambiar", None, QtGui.QApplication.UnicodeUTF8))
