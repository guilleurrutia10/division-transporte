...
# Form implementation generated from reading ui file 'WidgetListadoDeVehiculoEnRepPorSeccion.ui'
#
# Created: Wed Dec 05 21:19:25 2012
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label.setText(QtGui.QApplication.translate("Form", "Listado de Vehiculos en Reparacion por Sección", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setObjectName(_fromUtf8("label"))
        self.gridLayout.addWidget(self.label, 0, 0, 1, 1)
        self.groupBox = QtGui.QGroupBox(Form)
        self.groupBox.setMinimumSize(QtCore.QSize(321, 41))
        self.groupBox.setMaximumSize(QtCore.QSize(321, 41))
        self.groupBox.setTitle(QtGui.QApplication.translate("Form", "Buscar por Sección", None, QtGui.QApplication.UnicodeUTF8))
