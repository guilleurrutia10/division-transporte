...
#
# Created: Wed Jan 29 09:34:37 2014
...
class Ui_DialogAltaSeccion(object):
    def setupUi(self, DialogAltaSeccion):
        ...
        DialogAltaSeccion.resize(1221, 541)
        ...
        self.pushButtonDesasignarEncargado.setMaximumSize(QtCore.QSize(150, 16777215))
        ...
        item = QtGui.QTableWidgetItem()
        item.setText(QtGui.QApplication.translate("DialogAltaSeccion", "Numero de Documento", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.tableWidgetEncargadoAsignado.horizontalHeader().setDefaultSectionSize(150)
